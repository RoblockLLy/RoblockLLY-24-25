...
* Fecha: 11/05/2024
* Descripci�n: RobotManager: Manager de los robots, almacena los sensores instalados y los llama cuando es necesario
...
public class RobotManager : MonoBehaviour {
    ...
    public void EnableRobotPhysics() { // Activa la cinem�tica del robot
        GetComponent<Rigidbody>().isKinematic = false;
    }

    public void DisableRobotPhysics() { // Desactiva la cinem�tica del robot
    ...
    public void RemoveSensor(string snap) { // Dado el nombre de un snap point, se elimina el sensor instalado en �l y se destruye
        switch (snap) {
            case "front_snap":
                Destroy(frontSensor);
                frontSensor = null;
            ...
            case "front_left_snap":
                ...
                frontLeftSensor = null;
                break;
            case "front_right_snap":
                Destroy(frontRightSensor);
                frontRightSensor = null;
                break;
            case "left_snap":
                Destroy(leftSensor);
                leftSensor = null;
            ...
            case "internalSensor1":
                ...
                internalSensor1 = null;
                break;
            case "internalSensor2":
                Destroy(internalSensor2);
                internalSensor2 = null;
                break;
            case "internalSensor3":
                Destroy(internalSensor3);
                internalSensor3 = null;
                break;
            default:
                break;
        }
    ...
    public bool HasSensor(string sensorName) { // Devuelve s� o no, dependiendo de si un sensor se encuentra instalado en el robot
        // Guardamos todos los slots en una lista para m�s f�cil acceso
        ...
        // Preguntamos a cada sensor qu� tipo es, devolvemos true si encontramos uno del mismo nombre a buscar ("Contact", "Ultrasound", ...) o false si no
